...
music = int(input())
print('А какое твоё любимое время года (1 – осень, 2 – зима, 3 – весна, 4 – лето)')
season = int(input())
print('Какой твой любимый фрукт (1 – груша, 2 – яблоко, 3 – банан)')
fruits = int(input())
print(' Какое твое любимое животное (1 – кошка, 2 – собака, 3 – хомяк')
animals = int(input())
print('Какой твой любимый жанр фильмов (1 – романтика, 2 – ужасы, 3 – фантастика)')
films = int(input())
print(' Какой твой любимый напиток (1 – кола, 2 – фанта, 3 – спрайт)')
drinks = int(input())
